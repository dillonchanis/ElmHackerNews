						...
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_0: _elm_lang$html$Html_Attributes$href(
									A2(_elm_lang$core$Basics_ops['++'], 'https://news.ycombinator.com/user?id=', story.by)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(story.by),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(story.descendants),
												' comments'))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
...
var _user$project$HackerNews$viewSingleStory = function (story) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('story-item elevation'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$HackerNews$viewStoryPostInfo(story),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$HackerNews$viewStoryList = function (stories) {
	var storyList = A2(_elm_lang$core$List$map, _user$project$HackerNews$viewSingleStory, stories);
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		storyList);
};
var _user$project$HackerNews$viewFooter = A2(
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('footer-link'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Visit '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$a,
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('https://github.com/dillonchanis'),
										_1: {
											ctor: '::',
...
var _user$project$HackerNews$viewHeader = A2(
...
var _user$project$HackerNews$Story = F8(
	function (a, b, c, d, e, f, g, h) {
		return {by: a, descendants: b, id: c, kids: d, score: e, time: f, title: g, url: h};
	});
var _user$project$HackerNews$storyDecoder = A9(
	...
	_elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Json_Decode$field, 'url', _elm_lang$core$Json_Decode$string),
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Json_Decode$succeed(''),
				_1: {ctor: '[]'}
...
var _user$project$HackerNews$fetchStoryById = function (topStoryId) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$HackerNews$TopStory,
		A2(
			_elm_lang$http$Http$get,
			_user$project$HackerNews$apiGetItem(topStoryId),
			_user$project$HackerNews$storyDecoder));
};
var _user$project$HackerNews$fetchTopStories = function (topStoriesIds) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$HackerNews$fetchStoryById,
		A2(_elm_lang$core$List$take, 25, topStoriesIds));
};
...
var _user$project$HackerNews$getTopStories = A2(
	_elm_lang$http$Http$send,
	_user$project$HackerNews$Top,
	A2(
		_elm_lang$http$Http$get,
		_user$project$HackerNews$apiTopStoriesUrl,
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$int)));
var _user$project$HackerNews$init = {ctor: '_Tuple2', _0: _user$project$HackerNews$initialModel, _1: _user$project$HackerNews$getTopStories};
var _user$project$HackerNews$main = _elm_lang$html$Html$program(
	{
		init: _user$project$HackerNews$init,
		view: _user$project$HackerNews$view,
		update: _user$project$HackerNews$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['HackerNews'] = Elm['HackerNews'] || {};
if (typeof _user$project$HackerNews$main !== 'undefined') {
    _user$project$HackerNews$main(Elm['HackerNews'], 'HackerNews', undefined);
}
